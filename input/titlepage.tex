...
\newcommand{\projecttitle}{\Huge {Pdf Society }\vskip 0.1in}
...
\textnormal\bf{\bf Auribises Technologies, Ludhiana
\\from(    to     )
}
...
\vskip 1.7cm
\textnormal{Submitted By \vspace{5pt} \\ Navjot Singh (14112) \\ Manpreet Singh (14112)} 
\\ Deepak Pruthi (14112)
...
\textnormal{
\bf Information Technology Department \\ GURU NANAK DEV ENGINEERING COLLEGE 
}
 LUDHIANA, INDIA 
}
